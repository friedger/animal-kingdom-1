...
class Kingdom extends Component {
  ...
  publishClaim(subject) {
    var userData = this.userSession.loadUserData();
    this.userSession.lookupProfile(subject.username).then(subjectProfile => {
      ...
      const credSubject = {
        id: subjectProfile.did,
        memberOf: window.location.origin + "/kingdom/" + userData.username
      };
      ...
      jsigs
        .sign(credSubject, {
          suite: new EcdsaKoblitzSignature2016({
            privateKeyWif: wif.encode(0x80, userData.appPrivateKey, true),
            publicKeyWif: wif.encode(
              0x80,
  ...
  addSubject(e) {
    ...
    const content = {
      ...
      formatted_body:
        'I just added you to my kingdom! Come and join me <a href="https://planet.friedger.de"> there</a>!'
    };
    this.notifySubject(subject, content);
    this.publishClaim(subject);
      ...
      <div className="Kingdom">
        <div className="row">
          <div
            ...
            style={{
              backgroundImage: `url('${app}/territories/${
                rulerTerritory.id
              }.jpg')`
            }}
          >
            ...
            <p>
              {mine ? (
                ...
                <a
                  ...
                  }/kingdom/${currentUsername}?add=${app}/kingdom/${username}`}
                >
